...
#define DEFAULT_X_MAX_TRAVEL 25400 // mm NOTE: Must be a positive value.
#define DEFAULT_Y_MAX_TRAVEL 1250 // mm NOTE: Must be a positive value.
#define DEFAULT_Z_MAX_TRAVEL 100 // mm NOTE: Must be a positive value.
