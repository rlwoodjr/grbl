...
#define DEFAULT_A_STEPS_PER_MM 144
...
#define DEFAULT_X_MAX_TRAVEL 1075.0 // mm NOTE: Must be a positive value.
#define DEFAULT_A_MAX_TRAVEL 3600.0 // mm NOTE: Must be a positive value.
#define DEFAULT_Z_MAX_TRAVEL 98.0 // mm NOTE: Must be a positive value.
